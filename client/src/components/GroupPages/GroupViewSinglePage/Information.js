                    ...
                    <div className='py-10' >
                        <div className="lg:relative lg:h-96 border-gray-300 border-b-2 lg:mx-20 pb-10">
                            <div className="lg:absolute lg:top-5 lg:left-0 flex justify-center ">
                                <img className="rounded-[10px] w-[140px] xs:w-[170px] sm:w-[200px]" src="https://images.unsplash.com/photo-1548536646-b8bebe870011?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1287&q=80"/>
                            </div>
